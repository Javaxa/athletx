...
$(".supplementorderbutton").click(function() {
    $(".order-window-wrapper").fadeIn(200);
});

$(".order-window-wrapper").click(function(e) {
    if (this == e.target) {
        $(this).fadeOut(100);
    }
});

$(".order-window-close-button").click(function() {
    $(this).closest(".order-window-wrapper").fadeOut(100); 
});