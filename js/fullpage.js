/*$(window).on("scroll", function() {
 ...
 var moreInfoPosition = $("section.moreinfo").offset().top;
 if (scrollPosition >= moreInfoPosition) {
  $("section.moreinfo").addClass("biovisible");
 }
}); */

/*
    $(".moreinfo").on("mousemove", function() {
    $(this).addClass("biovisible");
    $(this).off("mousemove");
});*/
...
(function($) {
	$.fn.fullpage = function(options) {
		...
		options = $.extend({
			...
			'navigationColor': '#000',
			'navigationTooltips': ['Home', 'About', 'Store', 'Gallery', 'Contact'],
